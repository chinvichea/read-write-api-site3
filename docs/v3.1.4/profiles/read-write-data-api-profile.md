...
3. [Security &amp; Access Control](#security--access-control)
   ...
   6. [Consent Re-authentication](#consent-re-authentication)
      ...
      4. [Consent re-authentication through TPP](#consent-re-authentication-through-tpp)
         1. [Discovery of support for jwt-bearer grant-type.](#discovery-of-support-for-jwt-bearer-grant-type)
         2. [Client registration](#client-registration)
         3. [PSU identifiers](#psu-identifiers)
         4. [Using jwt-bearer for re-authentication](#using-jwt-bearer-for-re-authentication)
         5. [Vector of Trust](#vector-of-trust)
         6. [Example](#example)
